 ...
 */
function loginWithCustomToken(firebase, customToken) {
...
function attachCustomCommands(context, options) {
     ...
     * @name cy.login
     */
    Cypress.Commands.add(((_a = options === null || options === void 0 ? void 0 : options.commandNames) === null || _a === void 0 ? void 0 : _a.login) || 'login', (uid, customClaims) => {
        ...
        return cy
            ...
            .then((customToken) => loginWithCustomToken(firebase, customToken));
    });
    /**
     ...
     * cy.logout()
     */
    Cypress.Commands.add(((_b = options === null || options === void 0 ? void 0 : options.commandNames) === null || _b === void 0 ? void 0 : _b.logout) || 'logout', () => new Promise((resolve, reject) => {
        firebase.auth().onAuthStateChanged((auth) => {
            if (!auth) {
                resolve();
            }
