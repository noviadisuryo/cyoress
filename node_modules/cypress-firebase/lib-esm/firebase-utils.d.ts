 ...
 */
export declare function initializeFirebase(adminInstance: any, overrideConfig?: admin.AppOptions): admin.app.App;
/**
 ...
 */
export declare function slashPathToFirestoreRef(firestoreInstance: any, slashPath: string, options?: CallFirestoreOptions): admin.firestore.CollectionReference | admin.firestore.DocumentReference | admin.firestore.Query;
/**
 ...
 */
export declare function deleteCollection(db: any, collectionPath: string, batchSize?: number): Promise<any>;
