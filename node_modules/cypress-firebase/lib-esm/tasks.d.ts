 ...
 */
export declare function callFirestore(adminInstance: admin.app.App, action: FirestoreAction, actionPath: string, options?: CallFirestoreOptions, data?: FixtureData): Promise<any>;
/**
 ...
 * @returns Promise which resolves with a custom Firebase Auth token
 */
export declare function getAuthUser(adminInstance: any, uid: string): Promise<admin.auth.UserRecord>;
